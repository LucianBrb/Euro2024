...
public class MijlocasDefensiv extends Fotbalist implements MijlocasInterface, FundasInterface {
    public MijlocasDefensiv(String nume, String prenume, Integer varsta, String oras, Double rating, String nationalitate, Integer pozitieTeren, Integer nrTricou, String club, String nationala, Boolean esteCapitan, Boolean esteArbitru) {
