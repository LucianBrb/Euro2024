...
public class FundasCentral extends Fotbalist implements FundasInterface {
    public FundasCentral(String nume, String prenume, Integer varsta, String oras, Double rating, String nationalitate, Integer pozitieTeren, Integer nrTricou, String club, String nationala, Boolean esteCapitan, Boolean esteArbitru) {
